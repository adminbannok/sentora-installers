...
if [[ "$OS" = "CentOs" || "$OS" = "Fedora" ]]; then
	...
	if [[ "$VER" == "16.04" ]]; then
		$PACKAGE_INSTALLER php php-dev php-mysql libapache2-mod-php php-common php-cli php-zip php-gd php-mcrypt php-curl php-pear php-imap php-xmlrpc php7.0-xml php-intl php-mbstring mcrypt
	else
